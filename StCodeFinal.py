...
# OpenAI Chat + Embeddings (split packages)
...
with col1:
    st.image(load_square_image("birol.jpg"), caption="Dr. Birol Dindoruk", width=150)
    st.markdown(
...
with col2:
    st.image(load_square_image("utkarsh.jpg"), caption="Utkarsh Sinha", width=150)  # replace with correct path/URL
    st.markdown(
        "**Utkarsh Sinha**<br>"
